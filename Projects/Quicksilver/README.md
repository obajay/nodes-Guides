...
```python
cd $HOME
wget https://github.com/ingenuity-build/quicksilver/releases/download/v1.2.16/quicksilverd-v1.2.16-amd64
chmod +x quicksilverd-v1.2.16-amd64
mv $HOME/quicksilverd-v1.2.16-amd64 $HOME/go/bin/quicksilverd
```

...
```python
cd $HOME
wget https://github.com/CosmosContracts/juno/releases/download/v17.0.0-alpha.2/junod
chmod +x junod
...
#version: v17.0.0-alpha.2
#commit: 78b81c55a875dc6c2acc3be3580ea10ff2c7f6dd
mv junod $HOME/go/bin

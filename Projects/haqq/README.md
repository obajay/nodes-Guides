...
wget https://github.com/haqq-network/haqq/releases/download/v1.6.1/haqq_1.6.1_Linux_x86_64.tar.gz
tar -xvzf haqq_1.6.1_Linux_x86_64.tar.gz
cd bin
chmod +x haqqd
mv haqqd $HOME/go/bin/
cd $HOME && rm -rf haqq_1.6.1_Linux_x86_64.tar.gz
```
*******🟢UPDATE🟢******* 12.10.23
```python
cd $HOME

...
## Build
    ...
    teritorid init <moniker> --chain-id teritori-testnet-v1
    teritorid config chain-id teritori-testnet-v1
...
# Genesis
    ...
    wget https://raw.githubusercontent.com/TERITORI/teritori-chain/main/genesis/genesis.json -O $HOME/.teritorid/config/genesis.json
